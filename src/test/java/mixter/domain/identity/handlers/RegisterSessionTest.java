...
public class RegisterSessionTest {
    ...
    public void WhenUserConnectedThenStoreSessionProjection() {
        ...
        // Then
        SessionProjection sessionProjection = new SessionProjection(userConnected.getSessionId(), userConnected.getUserId(), true);
        assertThat(sessionRepository.getSessions()).containsExactly(sessionProjection);
    }

    @Test
    public void WhenUserDisconnectedThenStoreSessionProjectionDisabled() {
        // Given
        ...
        // Then
        SessionProjection sessionProjection = new SessionProjection(userDisconnected.getSessionId(), userDisconnected.getUserId(), false);
        assertThat(sessionRepository.getSessions()).containsExactly(sessionProjection);
    }
}
